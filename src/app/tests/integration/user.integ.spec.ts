...
// xdescribe('Pruebas de integración sobre usuarios', () => {
...
//         spyOn(mockUserDB, "createUser");
//         spyOn(mockUserDB, "deleteAuthUser");
//         spyOn(mockUserDB, "validateCredentials");
//         spyOn(mockUserDB, "logoutUser");
//
//         await TestBed.configureTestingModule({
//             providers: [
//                 UserService,
//                 {provide: USER_REPOSITORY, useClass: mockUserDB},
//                 appConfig.providers]
//         }).compileComponents();
//
...
//             expect(mockUserDB.createUser).toHaveBeenCalledWith(
//                 maria.email,
//                 maria.pwd,
//                 maria.nombre,
//                 maria.apellidos,
